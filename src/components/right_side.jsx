  ...
  return (
    <>
      ...
      <div className=" col-span-5 grid pt-[27%] max-2xl:pt-[10%] max-2xl:mb-20 max-2xl:col-span-12">
        <div className="">
          <div className="grid gap-5 max-2xl:text-center max-2xl:justify-center  ">
            <h1 className=" w-[85%] text-7xl font-bold tracking-[-3px] max-xl:text-5xl max-2xl:w-[80%]  max-2xl:m-auto max-lg:text-3xl  max-lg:tracking-[-2px]  max-2xl:text-center  justify-center flex">
            ...
            <div className="flex gap-5  max-2xl:flex max-2xl:justify-center">
              <div
